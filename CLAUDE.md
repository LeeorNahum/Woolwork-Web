...
`.agents/skills/branch-promote-skill/SKILL.md`
...
`.agents/skills/claude-code-compat-skill/SKILL.md`
...
`.agents/skills/convex-compendium-skill/SKILL.md`
...
`.agents/skills/design-md-skill/SKILL.md`
...
`.agents/skills/monolith-audit-skill/SKILL.md`
...
`.agents/skills/naming-check-skill/SKILL.md`
...
`.agents/skills/no-em-dashes-skill/SKILL.md`
...
`.agents/skills/provider-onboarding-skill/SKILL.md`
...
`.agents/skills/release-versioning-skill/SKILL.md`
...
`.agents/skills/skill-forge-skill/SKILL.md`
...
`.agents/skills/skill-sync-skill/SKILL.md`
...
`.agents/skills/web-repository-opinions-skill/SKILL.md`
...
`.agents/skills/woolwork-ui-skill/SKILL.md`
