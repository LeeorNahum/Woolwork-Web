...
version: alpha
name: Woolwork
description: A hand-stitched world of wool, felt, and yarn. Tokens mirror the Woolwork kit (woolwork.css v2.0.1), which is the wired token source for this repo.
colors:
  board: "#e3ddd0"
  cream: "#f6efdf"
  rose: "#e2707e"
...
The wired token source in this repository is `woolwork.css` (the kit, v2.0.1). This file is the reference those tokens follow; when the kit re-dyes, this file updates in the same change.
